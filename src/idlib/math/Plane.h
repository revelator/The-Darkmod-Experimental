...
ID_FORCE_INLINE void idPlane::GetPlaneParams(float &fa, float &fb, float &fc, float &fd) const
{
	fa = a;
	fb = b;
	fc = c;
...
ID_FORCE_INLINE bool idPlane::LineIntersection( const idVec3 &start, const idVec3 &end, float *fract ) const{
