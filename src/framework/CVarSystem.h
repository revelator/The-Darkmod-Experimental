...
public:
	...
	int						AddOnModifiedCallback( const OnModifiedFunc &callback ) {
		return internalVar->InternalAddOnModifiedCallback( callback );
	}
	void					RemoveOnModifiedCallback( int handle ) {
		internalVar->InternalRemoveOnModifiedCallback( handle );
	}
