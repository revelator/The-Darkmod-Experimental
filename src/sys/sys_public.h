...
// Revelator cant use __forceinline everywhere, probably carmack didnt know better back then.
// use __inline instead so that it just defaults to making the function static if inlining fails,
// and use the new define for functions where you are sure inlining works.
