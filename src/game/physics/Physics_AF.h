...
public:	// common physics interface
	...
	**/
	int						GetNumOrigBodies( void ) {
		return m_NumOrigBodies;
	};
	void					SetNumOrigBodies( int num ) {
		m_NumOrigBodies = num;
	};
	int						GetNumOrigConstraints( void ) {
		return m_NumOrigConstraints;
	};
	void					SetNumOrigConstraints( int num ) {
		m_NumOrigConstraints = num;
	};
