...
bool idGameLocal::InitFromSaveGame( const char *mapName, idRenderWorld *renderWorld, idSoundWorld *soundWorld, idFile *saveGameFile ) {
	...
	for( i = 0; i < mapFile->GetNumEntities(); i++ ) {
		...
		if( !InhibitEntitySpawn( mapEnt->epairs ) ) {
			...
			const char *classname; // fix for classname
	...
	*/
	...
	if( cmd == "mainmenu_heartbeat" ) {
		...
		if( cvarSystem->GetCVarInteger( "r_mode" ) == -1 ) {
			...
			switch( width ) {
			case 1024:
				cv_tdm_widescreenmode.SetInteger( 0 );
				break;
				// 1280 x 800 => 1
				// 1280 x 720 => 6
				// 1280 x 1024 => 10
			case 1280:
				cv_tdm_widescreenmode.SetInteger( height == 800 ? 1 : ( height == 720 ? 6 : 10 ) );
				break;
			case 1360:
				cv_tdm_widescreenmode.SetInteger( 13 );
				break;
			case 1366:
				cv_tdm_widescreenmode.SetInteger( 5 );
				break;
			case 1440:
				cv_tdm_widescreenmode.SetInteger( 2 );
				break;
				// 1600 x 900
			case 1600:
				cv_tdm_widescreenmode.SetInteger( 14 );
				break;
			case 1680:
				cv_tdm_widescreenmode.SetInteger( 3 );
				break;
				// 1800 x 1440
			case 1800:
				cv_tdm_widescreenmode.SetInteger( 11 );
				break;
			case 1920:
				cv_tdm_widescreenmode.SetInteger( height == 1200 ? 4 : 7 );
				break;
				// 2560 x 1440 => 8
				// 2560 x 1600 => 9
				// 2560 x 2048 => 12
			case 2560:
				cv_tdm_widescreenmode.SetInteger( height == 1440 ? 8 : height == 1600 ? 9 : 12 );
				break;
				// 3280 x 2048
			case 3280:
				cv_tdm_widescreenmode.SetInteger( 15 );
				break;
				// 3360 x 2100
			case 3360:
				cv_tdm_widescreenmode.SetInteger( 16 );
				break;
				// 3840 x 2160 => 17
				// 3840 x 2400 => 18
			case 3840:
				cv_tdm_widescreenmode.SetInteger( height == 2160 ? 17 : 18 );
				break;
			default:
				cv_tdm_widescreenmode.SetInteger( 0 );
				break;
