...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1 ) :
	...
	( *this )[0].type = argType1;
	( *this )[0].name = argName1;
	( *this )[0].desc = argDesc1;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,
	...
	( *this )[0].name = argName1;
	( *this )[0].desc = argDesc1;
	( *this )[1].type = argType2;
	( *this )[1].name = argName2;
	( *this )[1].desc = argDesc2;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,
	...
	( *this )[1].name = argName2;
	( *this )[1].desc = argDesc2;
	( *this )[2].type = argType3;
	( *this )[2].name = argName3;
	( *this )[2].desc = argDesc3;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,
	...
	( *this )[2].name = argName3;
	( *this )[2].desc = argDesc3;
	( *this )[3].type = argType4;
	( *this )[3].name = argName4;
	( *this )[3].desc = argDesc4;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,	// 5 args
	...
	( *this )[3].name = argName4;
	( *this )[3].desc = argDesc4;
	( *this )[4].type = argType5;
	( *this )[4].name = argName5;
	( *this )[4].desc = argDesc5;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,	// 6 args
	...
	( *this )[4].name = argName5;
	( *this )[4].desc = argDesc5;
	( *this )[5].type = argType6;
	( *this )[5].name = argName6;
	( *this )[5].desc = argDesc6;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,	// 7 args
	...
	( *this )[5].name = argName6;
	( *this )[5].desc = argDesc6;
	( *this )[6].type = argType7;
	( *this )[6].name = argName7;
	( *this )[6].desc = argDesc7;
}
...
inline EventArgs::EventArgs( char argType1, const char *argName1, const char *argDesc1,	// 8 args
	...
	( *this )[6].name = argName7;
	( *this )[6].desc = argDesc7;
	( *this )[7].type = argType8;
	( *this )[7].name = argName8;
	( *this )[7].desc = argDesc8;
}
