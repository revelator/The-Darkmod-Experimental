...
public:
	...
	*/
	const idVec3 	&GetLightOrigin( void ) const {
		return renderLight.origin;
	}
	...
	idVec3			GetRadius( void ) const {
		return idVec3( renderLight.lightRadius[0], renderLight.lightRadius[1], renderLight.lightRadius[2] );
	}
	...
	inline bool		IsParallel( void ) {
		return renderLight.parallel;
	};
	inline bool		IsPointlight( void ) {
		return renderLight.pointLight;
	};
