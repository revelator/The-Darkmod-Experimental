...
public:
	...
	**/
	...
	int						GetModelDefHandle( void ) const  {
	...
	**/
	...
	CStimResponseCollection *GetStimResponseCollection( void ) {
		return m_StimResponseColl;
	};
	...
	**/
	...
	void					EnableResponse( StimType type ) {
		SetResponseEnabled( type, true );
	}
	void					DisableResponse( StimType type ) {
		SetResponseEnabled( type, false );
	}

	// Enables / disables the given response
	void					SetResponseEnabled( StimType type, bool enabled );

	void					EnableStim( StimType type ) {
		SetStimEnabled( type, true );
	}
	void					DisableStim( StimType type ) {
		SetStimEnabled( type, false );
	}
